...
public class ListenUserMissingReports extends Service implements ChildEventListener {
    ...
    public void onCreate() {
        ...
        databaseReference = firebaseDatabase.getReference("Missing");
    }
    ...
    public ListenUserMissingReports() {
    }
    ...
    public void onChildChanged(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
        ...
        Missing newReport = dataSnapshot.getValue(Missing.class);
    ...
    private void showNotification(String key, Missing newReport) {
...
//        PendingIntent pendingIntent = PendingIntent.getActivity(getBaseContext(),0,intent,0);
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(getBaseContext(),
                ...
                .setContentText( "Your Report Status Changed to " + newReport.getMissingStatus());
